...
* Making a Poll
  * Select a Text-Channel the Poll can take place in.
  * Enter the topic of a Poll. It could be anything. :D
  * Create Answers that People can vote on.
  * You can see a small preview of the Poll within a small window.
  * Use the buttons to start the Poll, stop it prematurely or cancel it.
